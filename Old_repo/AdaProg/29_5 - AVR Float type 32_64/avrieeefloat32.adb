...
package body AVRIEEEFloat32 is
   ...
   function "=" (Left,Right : IEEE_Float32) return Boolean is
   begin
   ...
   function "+" (Left,Right : IEEE_Float32) return IEEE_Float32 is
      result : IEEE_Float32;
   ...
   function To_IEEE_Float_32(Number : Unsigned_8) return IEEE_Float32 is
      temp : IEEE_Float32;
      Uns : Unsigned_32;
   ...
   function To_IEEE_Float_32(Number : Unsigned_16) return IEEE_Float32 is
      temp : IEEE_Float32;
      Uns : Unsigned_32;
      ExpoT : Float_32_Expo := 127;
   begin
   ...
   function To_IEEE_Float_32(Number : Unsigned_32) return IEEE_Float32 is
      temp : IEEE_Float32;
      Uns : Unsigned_32;
      ExpoT : Float_32_Expo := 127;
   begin
   ...
   function To_Unsigned8(Number : IEEE_Float32) return Unsigned_8 is
      Num : Unsigned_8;
      Uns : Unsigned_32;
   ...
   function To_Unsigned16(Number : IEEE_Float32) return Unsigned_16 is
      Num : Unsigned_16;
      Uns : Unsigned_32;
      ExpoT : Float_32_Expo := Number.E;
   begin
   ...
   function To_Unsigned32(Number : IEEE_Float32) return Unsigned_32 is
      Num : Unsigned_32;
      ExpoT : Float_32_Expo := Number.E;
   begin
   ...
   function To_IEEE_Float_32(Number : Integer_8) return IEEE_Float32 is
      temp : IEEE_Float32;
      Int : Integer_32;
      ExpoT : Float_32_Expo := 127;
   begin
   ...
   function To_IEEE_Float_32(Number : Integer_16) return IEEE_Float32 is
      temp : IEEE_Float32;
      Int : Integer_32;
      ExpoT : Float_32_Expo := 127;
   begin
   ...
   function To_IEEE_Float_32(Number : Integer_32) return IEEE_Float32 is
      temp : IEEE_Float32;
      Int : Integer_32;
      ExpoT : Float_32_Expo := 127;
   begin
   ...
   function To_Integer8(Number : IEEE_Float32) return Integer_8 is
      Num : Integer_8;
      Int : Integer_32;
      ExpoT : Float_32_Expo := Number.E;
   begin
   ...
   function To_Integer16(Number : IEEE_Float32) return Integer_16 is
      Num : Integer_16;
      Int : Integer_32;
      ExpoT : Float_32_Expo := Number.E;
   begin
   ...
   function To_Integer32(Number : IEEE_Float32) return Integer_32 is
      Num : Integer_32;
      ExpoT : Float_32_Expo := Number.E;
   begin
      -- As -2**31 <= Num < 2**31
   ...
   -- function To_String(Number : IEEE_Float32) return String is
   -- buf : String := "";
   -- i,p : Integer := 1;
