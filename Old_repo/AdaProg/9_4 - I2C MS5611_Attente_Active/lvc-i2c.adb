...
--                        others => False);
      ...
      -- Wait for start
      loop
         exit when (((MCU.TWSR and 16#08#) = 16#08#) or ((MCU.TWSR and 16#10#) = 16#10#));--MCU.TWSR = 16#08#);
      end loop;
...
--      end if;
      ...
      -- Wait for the ack
      loop
         exit when ((MCU.TWSR and 16#18#) = 16#18#);--MCU.TWSR = 16#08#);
      end loop;
...
--      end if;
      ...
      -- Wait for the ack
      loop
         exit when ((MCU.TWSR and 16#28#) = 16#28#);--(MCU.TWSR <= MCU.TWINT_Mask);--MCU.TWSR = 16#08#);
      end loop;
