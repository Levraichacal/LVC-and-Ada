...
package AVR.ATtiny841.Bootloader is
   pragma Preelaborate;

   CVS_Version : constant String := "$Id: avr-attiny841-bootloader.ads 881 2008-11-16 22:55:31Z Rolf_Ebert $";
