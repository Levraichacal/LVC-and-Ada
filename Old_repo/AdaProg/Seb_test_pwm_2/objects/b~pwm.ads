...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_pwm" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#56f87d49#;
   pragma Export (C, u00001, "pwmB");
   ...
   u00032 : constant Version_32 := 16#52e76d8e#;
   pragma Export (C, u00032, "avr__timer1B");
   u00033 : constant Version_32 := 16#2c1939e1#;
