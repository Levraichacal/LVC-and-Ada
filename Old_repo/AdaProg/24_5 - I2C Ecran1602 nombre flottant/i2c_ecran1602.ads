...
-- Procedures
   ...
   procedure LCD_Print(Message : Integer_8);

   procedure LCD_Print(Message : Integer_16);

   procedure LCD_Print(Message : Integer_32);

   procedure LCD_Print(Message : Float; Number : Unsigned_8 := 2);

   --procedure LCD_Print(Message : IEEE_Float_32; Number : Unsigned_8 := 2);
