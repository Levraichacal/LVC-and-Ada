...
package LCD is
   ...
   procedure Put (S : Unsigned_8; base : Unsigned_8 := 10);
   procedure Put (S : Unsigned_16; base : Unsigned_8 := 10);
   procedure Put (S : Unsigned_32; base : Unsigned_8 := 10);
   procedure Put (S : Integer_8);
   procedure Put (S : Integer_16);
   procedure Put (S : Integer_32);
