...
package body LCD is
   ...
   --  output at the current cursor location
   procedure Put (S : Unsigned_8; base : Unsigned_8 := 10) is
      buf : AVR_String := " ";
      n,m,a : Unsigned_8 := S;
      i : Unsigned_8;
   begin
   ...
   --  output at the current cursor location
   procedure Put (S : Unsigned_16; base : Unsigned_8 := 10) is
      buf : AVR_String := " ";
      n,m,a : Unsigned_16 := S;
      i : Unsigned_8;
   begin
   ...
   --  output at the current cursor location
   procedure Put (S : Unsigned_32; base : Unsigned_8 := 10) is
      buf : AVR_String := " ";
      n,m,a : Unsigned_32 := S;
      i : Unsigned_8;
   begin
