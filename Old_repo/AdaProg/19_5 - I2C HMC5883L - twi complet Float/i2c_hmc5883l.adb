...
--                                     Target => Data_Buffer);
   ...
   begin
      case HMC5883L_range is
         when HMC5883L_RANGE_0_88GA =>
            val := 2#000#;
            mgPerDigit := To_IEEE_Float_32(Unsigned_16(73)/Unsigned_16(1000));

         when HMC5883L_RANGE_1_3GA =>
            val := 2#001#;
            mgPerDigit := To_IEEE_Float_32(Unsigned_16(92)/Unsigned_16(100));

         when HMC5883L_RANGE_1_9GA =>
            val := 2#010#;
            mgPerDigit := To_IEEE_Float_32(Unsigned_16(122)/Unsigned_16(100));

         when HMC5883L_RANGE_2_5GA =>
            val := 2#011#;
            mgPerDigit := To_IEEE_Float_32(Unsigned_16(152)/Unsigned_16(100));

         when HMC5883L_RANGE_4GA =>
            val := 2#100#;
            mgPerDigit := To_IEEE_Float_32(Unsigned_16(227)/Unsigned_16(100));

         when HMC5883L_RANGE_4_7GA =>
            val := 2#101#;
            mgPerDigit := To_IEEE_Float_32(Unsigned_16(256)/Unsigned_16(100));

         when HMC5883L_RANGE_5_6GA =>
            val := 2#110#;
            mgPerDigit := To_IEEE_Float_32(Unsigned_16(303)/Unsigned_16(100));

         when HMC5883L_RANGE_8_1GA =>
            val := 2#111#;
            mgPerDigit := To_IEEE_Float_32(Unsigned_16(435)/Unsigned_16(100));
   ...
   begin
      ...
      Request_Data(HMC5883L_ADDRESS,2);
      temp := Receive;
      tempVector.X := To_IEEE_Float_32(U8_To_U16(temp)*256 + U8_To_U16(Receive) - U8_To_U16(xOffset));
      Write_Data(HMC5883L_ADDRESS,tempBuff(2..2));
      Request_Data(HMC5883L_ADDRESS,2);
      temp := Receive;
      tempVector.Y := To_IEEE_Float_32(U8_To_U16(temp)*256 + U8_To_U16(Receive)- U8_To_U16(yOffset));
      Write_Data(HMC5883L_ADDRESS,tempBuff(3..3));
      Request_Data(HMC5883L_ADDRESS,2);
      temp := Receive;
      tempVector.Z := To_IEEE_Float_32(U8_To_U16(temp)*256 + U8_To_U16(Receive));
      return tempVector;
   end readRaw;

   function readNormalize return Vector is
      temp : Unsigned_8;
      tempVector : Vector;
      tempBuff : Data_Buffer(1..3);
   begin
      ...
      Request_Data(HMC5883L_ADDRESS,2);
      temp := Receive;
      tempVector.X := To_IEEE_Float_32(U8_To_U16(temp)*256 + U8_To_U16(Receive) - U8_To_U16(xOffset))*mgPerDigit;
      Write_Data(HMC5883L_ADDRESS,tempBuff(2..2));
      Request_Data(HMC5883L_ADDRESS,2);
      temp := Receive;
      tempVector.Y := To_IEEE_Float_32(U8_To_U16(temp)*256 + U8_To_U16(Receive)- U8_To_U16(yOffset))*mgPerDigit;
      Write_Data(HMC5883L_ADDRESS,tempBuff(3..3));
      Request_Data(HMC5883L_ADDRESS,2);
      temp := Receive;
      tempVector.Z := To_IEEE_Float_32(U8_To_U16(temp)*256 + U8_To_U16(Receive))*mgPerDigit;
      return tempVector;
   end readNormalize;
