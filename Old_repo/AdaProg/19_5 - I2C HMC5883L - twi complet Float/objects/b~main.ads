...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#2c4a3330#;
   pragma Export (C, u00001, "mainB");
   u00002 : constant Version_32 := 16#3ffc8e18#;
   pragma Export (C, u00002, "adaS");
   u00003 : constant Version_32 := 16#91391aa5#;
   pragma Export (C, u00003, "ada__calendar__delaysS");
   u00004 : constant Version_32 := 16#13c4ef93#;
   pragma Export (C, u00004, "ada__calendarS");
   ...
   u00040 : constant Version_32 := 16#700032f8#;
   pragma Export (C, u00040, "avrieeefloat32uartB");
   u00041 : constant Version_32 := 16#80da28fb#;
   pragma Export (C, u00041, "avrieeefloat32uartS");
   u00042 : constant Version_32 := 16#b1e037fa#;
   pragma Export (C, u00042, "avrieeefloat32B");
   u00043 : constant Version_32 := 16#25a4fe9f#;
   pragma Export (C, u00043, "avrieeefloat32S");
   u00044 : constant Version_32 := 16#cf0539d8#;
   pragma Export (C, u00044, "i2c_hmc5883lB");
   u00045 : constant Version_32 := 16#97bbd629#;
   pragma Export (C, u00045, "i2c_hmc5883lS");
   ...
   --  avrieeefloat32%s
   --  avrieeefloat32%b
   --  avrieeefloat32uart%s
   --  avrieeefloat32uart%b
   --  i2c_hmc5883l%s
   --  main%b
   --  two_wire%s
   --  two_wire%b
