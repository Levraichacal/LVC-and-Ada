...
--                                     Target => Data_Buffer);
   ...
   begin
      ...
      Request_Data(HMC5883L_ADDRESS,2);
      temp := Receive;
      tempVector.X := IEEE_Float_32(U8_To_U16(temp)*256 + U8_To_U16(Receive) - U8_To_U16(xOffset));
      Write_Data(HMC5883L_ADDRESS,tempBuff(2..2));
      Request_Data(HMC5883L_ADDRESS,2);
      temp := Receive;
      tempVector.Y := IEEE_Float_32(U8_To_U16(temp)*256 + U8_To_U16(Receive)- U8_To_U16(yOffset));
      Write_Data(HMC5883L_ADDRESS,tempBuff(3..3));
      Request_Data(HMC5883L_ADDRESS,2);
      temp := Receive;
      tempVector.Z := IEEE_Float_32(U8_To_U16(temp)*256 + U8_To_U16(Receive));
      return tempVector;
   end readRaw;
   ...
   begin
      ...
      Request_Data(HMC5883L_ADDRESS,2);
      temp := Receive;
      tempVector.X := IEEE_Float_32((U8_To_U32(temp)*256 + U8_To_U32(Receive) - U8_To_U32(xOffset)))*mgPerDigit;
      Write_Data(HMC5883L_ADDRESS,tempBuff(2..2));
      Request_Data(HMC5883L_ADDRESS,2);
      temp := Receive;
      tempVector.Y := IEEE_Float_32((U8_To_U32(temp)*256 + U8_To_U32(Receive)- U8_To_U32(yOffset)))*mgPerDigit;
      Write_Data(HMC5883L_ADDRESS,tempBuff(3..3));
      Request_Data(HMC5883L_ADDRESS,2);
      temp := Receive;
      tempVector.Z := IEEE_Float_32((U8_To_U32(temp)*256 + U8_To_U32(Receive)))*mgPerDigit;
      return tempVector;
   end readNormalize;
