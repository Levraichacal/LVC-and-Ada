...
procedure Test_74hc595 is
   ...
   begin
      Init(Affichage(1), D12, D11, D13);
      Init(Affichage(2), D12, D10, D13);
      Init(Affichage(3), D12, D9, D13);
      Init(Affichage(4), D12, D8, D13);
      Init(Affichage(5), D12, D7, D13);
      Init(Affichage(6), D12, D6, D13);
      Init(Affichage(7), D12, D5, D13);
      Init(Affichage(8), D12, D4, D13);
      Init(Affichage(9), D12, D3, D13);
      Init(Affichage(10), D12, D2, D13);
      Init(Affichage(11), D12, D1, D13);
      Init(Affichage(12), D12, D0, D13);
   end Init_Affichage;
