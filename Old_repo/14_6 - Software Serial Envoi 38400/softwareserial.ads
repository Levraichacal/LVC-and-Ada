...
package SoftwareSerial is
   ...
   procedure Init_SoftSerial(transmitPin : lvcPins; inverseLogic : Boolean := False);
...
--   procedure end_SoftSerial(pin : lvcPins);
   ...
   procedure init_Interrupt_Com;

   procedure init_Serial_Com;
...
private
   ...
   G_XMIT_STAT_ADJUSTEMENT : Unsigned_16 := 6;
