...
--                                                                          --
------------------------------------------------------------------------------
--    This package enable to configure the Timer 4 (16-bit one) to ensure   --
--    the pwm on port PH3, PH4, PH5 on the ATmega2560 ie port D6, D7 and    --
--    D8 of the Arduino Mega 2560.                                          --
------------------------------------------------------------------------------
with Interfaces;


package LVC.PWM.TIMER4 is
...
--    Init_Port_PWM(6);  -- Initialise Timer 4 and D6 port as a PWM output  --
--    Write_PWM(6,1500); -- Write 1500, mid value of standard PWM, on       --
--    port D6                                                               --
------------------------------------------------------------------------------
