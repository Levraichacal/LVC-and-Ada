...
procedure Blink is
   ...
   -- Déclaration de la variable LED_PIN comme étant constante de valeur 7
   LED_PIN : constant := 7;
   
-- Début du programme
begin
   -- Déclaration du port PB7 comme étant une sortie 
   ...
   loop
      ...
      Led_On := not Led_On;
      -- On attribue au port PB7 la valeur du booléen
