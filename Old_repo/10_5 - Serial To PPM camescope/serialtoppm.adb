...
-----------------------------------------------------------------------------------------------------------
   ...
   type servoStep is (A1,A2,B1,B2,C1,C2,D1,D2,E1,E2,F1,F2,G1,G2,H1,H2,Z1,Z2);
...
-----------------------------------------------------------------------------------------------------------
   ...
   servo_width : Tableau_Data := (PWM_Safe,PWM_Safe,PWM_Safe,PWM_Safe,PWM_Safe,PWM_Safe,PWM_Safe,PWM_Safe);
   servo_width_temp : Tableau_Data := (PWM_Safe,PWM_Safe,PWM_Safe,PWM_Safe,PWM_Safe,PWM_Safe,PWM_Safe,PWM_Safe);
