...
package LVC.TIME body is
   ...
   begin
      ...
      MCU.TIMSKO_Bits(TOIE0_Bit) := True;
   ...
   begin
      MCU.TCNTO := 16#06#;
      timer_0_micros := timer_0_micro + 250;
   end Timer0_Interrupt;

   function Millis return Unsigned_31 is
   begin
      return Micros/1000;
   end Millis;
   ...
   begin
      ...
      -- Disable Interrupt.
      AVR.Interrupts.Disable;
      micros := timer_0_micros + MCU.TCNT0 /2;
      MCU.SREG := old_sreg;
      AVR.Interrupts.Enable;
      return micros;
   end Micros;
