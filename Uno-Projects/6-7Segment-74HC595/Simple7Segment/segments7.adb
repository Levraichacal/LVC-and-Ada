...
procedure Segments7 is
   ...
   begin
      case Number is
         when '0' => -- Print 0
            Write7Segments(True, True, True, True, True, True, False, False);
         when '1' => -- Print 1
            Write7Segments(False, True, True, False, False, False, False, False);
         when '2' => -- Print 2
            Write7Segments(True, True, False, True, True, False, True, False);
         when '3' => -- Print 3
            Write7Segments(True, True, True, True, False, False, True, False);
         when '4' => -- Print 4
            Write7Segments(False, True, True, False, False, True, True, False);
         when '5' => -- Print 5
            Write7Segments(True, False, True, True, False, True, True, False);
         when '6' => -- Print 6
            Write7Segments(True, False, True, True, True, True, True, False);
         when '7' => -- Print 7
            Write7Segments(True, True, True, False, False, False, False, False);
         when '8' => -- Print 8
            Write7Segments(True, True, True, True, True, True, True, False);
         when '9' => -- Print 9
            Write7Segments(True, True, True, True, False, True, True, False);
