...
package lib47segments is
   ...
   procedure PrintNumber47Segments(Chip : T_47Segments; SegmentNumber : Integer; Number : Character);

   --  Write the Print Numbers
   procedure PrintNumber47Segments(Chip : T_47Segments; Numbers : T_4Chars);
